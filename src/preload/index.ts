...
const api: AideAPI = {
  ...
  connections: {
    ...
    foundryCreateDeployment: (subId: string, rg: string, account: string, depName: string, modelName: string, modelVer: string, modelFmt: string) => ipcRenderer.invoke('connections:foundryCreateDeployment', subId, rg, account, depName, modelName, modelVer, modelFmt),
