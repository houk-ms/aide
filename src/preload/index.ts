...
const api: AideAPI = {
  ...
  connections: {
    ...
    foundryLogin: () => ipcRenderer.invoke('connections:foundryLogin'),
    foundryListResources: () => ipcRenderer.invoke('connections:foundryListResources'),
    foundryListDeployments: (subId: string, rg: string, account: string) => ipcRenderer.invoke('connections:foundryListDeployments', subId, rg, account),
    foundrySelect: (subId: string, rg: string, account: string, endpoint: string, deployment: string, model: string) => ipcRenderer.invoke('connections:foundrySelect', subId, rg, account, endpoint, deployment, model),
    foundryListSubscriptions: () => ipcRenderer.invoke('connections:foundryListSubscriptions'),
    foundryListLocations: (subId: string) => ipcRenderer.invoke('connections:foundryListLocations', subId),
    foundryListAvailableModels: (subId: string, rg: string, account: string) => ipcRenderer.invoke('connections:foundryListAvailableModels', subId, rg, account),
    foundryCreateResource: (subId: string, location: string, rg: string, name: string) => ipcRenderer.invoke('connections:foundryCreateResource', subId, location, rg, name),
    foundryCreateDeployment: (subId: string, rg: string, account: string, depName: string, modelName: string, modelVer: string, modelFmt: string, skuName: string) => ipcRenderer.invoke('connections:foundryCreateDeployment', subId, rg, account, depName, modelName, modelVer, modelFmt, skuName),
    disconnect: (type: any) => ipcRenderer.invoke('connections:disconnect', type),
    getFoundryConfig: () => ipcRenderer.invoke('connections:getFoundryConfig'),
